  ...
  function mpreloader_finished() {
    if (window.matrixloaderPublic.loader_delay > 0) {
      setTimeout(function () {
        ...
        if (animate_out != '') {
          var x = document.getElementsByClassName("loader-text-inner")[0];
          x.remove();
          var x2 = document.getElementsByClassName("loader-inner")[0];
          x2.remove();
...
module.exports = __webpack_require__(/*! C:\Users\Asus\Local Sites\wpfluentforms\app\public\wp-content\plugins\matrix-pre-loader\src\js\matrix-loader-public */"./src/js/matrix-loader-public.js");
